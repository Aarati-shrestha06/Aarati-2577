...
print(vowel_letters("Python Practice"))
...
print(palindrome_function("They are nothing"))  
print(palindrome_function("here"))     
...
def longest_word(sentence):
    ...
    for word in words:
        if len(word) > len(longest):
            longest = word
    return longest
print(longest_word("Write a function that takes a sentence and returns the longest word"))
